class CommentsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @comment.update(comment_params)
        format.html { redirect_to topic_path(@comment.topic), notice: 'Comment was successfully updated.' }
  ...
  def destroy
    ...
    @comment.destroy
    respond_to do |format|
      format.html { redirect_to @topicD, notice: 'Comment was successfully destroyed.' }
